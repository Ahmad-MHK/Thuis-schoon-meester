...
<body>
    <div id="Main">
        @include('Header') <!-- Laravel Blade directive to include the header -->
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid lg:grid-cols-2 grid-cols-1">
                                ...
                                <div class="relative h-full">
                                    ...
                                    <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                        <div class="bg-white rounded-lg p-6 block">
                                            <a href="tel:470-601-1911" class="flex items-center mb-6">
                                            ...
                                            <a href="mailto:info@yourcompany.com" class="flex items-center mb-6">
                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <h5 class="text-black text-base font-normal leading-6 ml-5">info@yourcompany.com</h5>
                                            </a>
                        ...
                        <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                            ...
                            <input type="text" name="name" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Name" required>
                            <input type="email" name="email" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Email" required>
                            <input type="text" name="phone" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Phone">
                            <div class="mb-10">
                            </div>
                            <textarea name="message" class="w-full h-32 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-md border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Message" required></textarea>
        ...
        @include('Footer') <!-- Laravel Blade directive to include the footer -->
    </div>
</body>
